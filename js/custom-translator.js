...
.config(['$translateProvider', function($translateProvider){
  ...
  $translateProvider.translations('pl_PL', {
    ...
    "LABODA_4"	: "Ceremonia w kościele w Hiszpanii odbywa sie podobnie do naszej, tylko jest po hiszpańsku ;). Dokładamy wszelkich starań, aby nasz ślub mógł być dwujęzyczny, przynajmniej jeśli chodzi o przysięgę (aby każdy rozunmiał co przysięga ;)). Odmienne jest jedynie wejście do kośioła, kiedy to Pan Młody jest wprowadzany przez mamę, zaś po nim wchodzi Panna Młoda ze swoim tatą.",
    ...
    "TURISMO_21"	: "Polecamy wejście na wieżę, z której roztacza się widok na Lublin",
    "TURISMO_22"	: "Zalew Zemborzycki",
    "TURISMO_23"	: "W lecie możecie tutaj spróbować swoich sił jeżdżąc na nartach wodnych. Można tu też korzystać z basenów lub wybrać się na grilla.",
